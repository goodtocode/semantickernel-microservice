...
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Audio", "Get Text Audio Paginated Query", "As an owner of text audio\r\nWhen I get text audio all or by date range\r\nI can get " +
                    "a paginated collection of text audio", ProgrammingLanguage.CSharp, featureTags);
        ...
        public void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "Get Text Audio Paginated Query")))
            {
                global::Goodtocode.SemanticKernel.Specs.Integration.Audio.GetTextAudioPaginatedQueryFeature.FeatureSetup(null);
            }
        }
        ...
        public virtual void GetTextAudioPaginated(string def, string response, string responseErrors, string startDate, string endDate, string exist, string textPromptsResultExists, string pageNumber, string pageSize, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Get text audio paginated", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 7
...
#line hidden
#line 15
 testRunner.When("I get the text audio paginated", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 16
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get text audio paginated: success no date range")]
        ...
        public void GetTextAudioPaginated_SuccessNoDateRange()
        {
#line 7
this.GetTextAudioPaginated("success no date range", "Success", "", "", "", "true", "true", "1", "10", ((string[])(null)));
#line hidden
        }
        
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get text audio paginated: success with date range")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Get Text Audio Paginated Query")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("getTextAudioPaginatedQuery")]
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:pageNumber", "1")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:pageSize", "10")]
        public void GetTextAudioPaginated_SuccessWithDateRange()
        {
#line 7
this.GetTextAudioPaginated("success with date range", "Success", "", "2024-06-01T11:21:00Z", "2024-06-03T11:21:00Z", "true", "true", "1", "10", ((string[])(null)));
#line hidden
        }
        
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get text audio paginated: success empty results")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Get Text Audio Paginated Query")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("getTextAudioPaginatedQuery")]
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:pageNumber", "1")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:pageSize", "10")]
        public void GetTextAudioPaginated_SuccessEmptyResults()
        {
#line 7
this.GetTextAudioPaginated("success empty results", "Success", "", "", "", "false", "false", "1", "10", ((string[])(null)));
#line hidden
        }
        
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get text audio paginated: bad request page number zero")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Get Text Audio Paginated Query")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("getTextAudioPaginatedQuery")]
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:pageSize", "10")]
        public void GetTextAudioPaginated_BadRequestPageNumberZero()
        {
#line 7
this.GetTextAudioPaginated("bad request page number zero", "BadRequest", "PageNumber", "", "", "false", "false", "0", "10", ((string[])(null)));
#line hidden
        }
        
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get text audio paginated: bad request page size zero")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Get Text Audio Paginated Query")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("getTextAudioPaginatedQuery")]
        ...
        public void GetTextAudioPaginated_BadRequestPageSizeZero()
        {
#line 7
this.GetTextAudioPaginated("bad request page size zero", "BadRequest", "PageSize", "", "", "false", "false", "1", "0", ((string[])(null)));
#line hidden
        }
    }
}

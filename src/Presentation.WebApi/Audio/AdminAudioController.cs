...
[Route("api/v{version:apiVersion}/admin/audio")]
[Authorize]
[ApiVersion("1.0")]
public class AdminAudioController : ApiControllerBase
{
    ...
    [ProducesResponseType<TextAudioDto>(StatusCodes.Status200OK)]
    ...
    [ProducesResponseType<ICollection<TextAudioDto>>(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status401Unauthorized)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    ...
    [ProducesResponseType<PaginatedList<TextAudioDto>>(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status401Unauthorized)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    ...
    [ProducesResponseType<TextAudioDto>(StatusCodes.Status201Created)]

...
[ApiVersion("1.0")]
[Authorize]
public class AdminImageController : ApiControllerBase
{
    ...
    [ProducesResponseType<TextImageDto>(StatusCodes.Status200OK)]
    ...
    [ProducesResponseType<ICollection<TextImageDto>>(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status401Unauthorized)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    ...
    [ProducesResponseType<PaginatedList<TextImageDto>>(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status401Unauthorized)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    ...
    [ProducesResponseType<TextImageDto>(StatusCodes.Status201Created)]

...
[Route("api/v{version:apiVersion}/admin/text")]
[ApiVersion("1.0")]
[Authorize]
public class AdminTextGenerationController : ApiControllerBase
{
    ...
    [ProducesResponseType<TextPromptDto>(StatusCodes.Status200OK)]
    ...
    [ProducesResponseType<ICollection<TextPromptDto>>(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status401Unauthorized)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    ...
    [ProducesResponseType<PaginatedList<TextPromptDto>>(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status401Unauthorized)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]

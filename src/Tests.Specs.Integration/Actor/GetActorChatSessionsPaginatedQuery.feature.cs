...
namespace Goodtocode.SemanticKernel.Specs.Integration.Actor
{
    ...
    public partial class GetActorChatSessionsPaginatedQueryFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Actor", "Get Actor Chat Sessions Paginated Query", "As an actor of chat sessions\r\nWhen I get chat sessions by actor or by date range\r" +
...
#line 1 "GetActorChatSessionsPaginatedQuery.feature"
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Actor/GetActorChatSessionsPaginatedQuery.feature.ndjson", 8);
        }
        
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute(callerLineNumber: 7, DisplayName="Get actor chat sessions paginated")]
        ...
        public async global::System.Threading.Tasks.Task GetActorChatSessionsPaginated(string def, string response, string responseErrors, string id, string startDate, string endDate, string exist, string chatSessionsResultExists, string pageNumber, string pageSize, string @__pickleIndex, string[] exampleTags)
        {
            ...
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Get actor chat sessions paginated", null, tagsOfScenario, argumentsOfScenario, featureTags, pickleIndex);

...
namespace Goodtocode.SemanticKernel.Specs.Integration.Actor
{
    ...
    public partial class CreateActorCommandFeature
    {
...
#line hidden
        ...
        public async global::System.Threading.Tasks.Task CreateActor(string def, string response, string responseErrors, string id, string ownerId, string exists, string name, string email, string @__pickleIndex, string[] exampleTags)
        {
            ...
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Create Actor", null, tagsOfScenario, argumentsOfScenario, featureTags, pickleIndex);

...
namespace Goodtocode.SemanticKernel.Specs.Integration.Actor
{
    ...
    public partial class GetActorChatSessionsQueryFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Actor", "Get Actor Chat Sessions Query", "As an actor\r\nWhen I query chat sessions optionally by date range\r\nI get all sessi" +
                "ons that fit the date range", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
        
#line 1 "GetActorChatSessionsQuery.feature"
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Actor/GetActorChatSessionsQuery.feature.ndjson", 6);
        }
        
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute(callerLineNumber: 7, DisplayName="Get actor chat sessions")]
        ...
        public async global::System.Threading.Tasks.Task GetActorChatSessions(string def, string response, string responseErrors, string id, string startDate, string endDate, string exist, string chatSessionsResultExists, string @__pickleIndex, string[] exampleTags)
        {
            ...
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Get actor chat sessions", null, tagsOfScenario, argumentsOfScenario, featureTags, pickleIndex);

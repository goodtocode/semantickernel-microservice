...
namespace Goodtocode.SemanticKernel.Specs.Integration.Actor
{
    ...
    public partial class GetActorChatSessionQueryFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Actor", "Get Actor Chat Session Query", "As a chat user actor\r\nWhen I select an existing chat session\r\nI can get the chat " +
                "history messages", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
        
#line 1 "GetActorChatSessionQuery.feature"
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Actor/GetActorChatSessionQuery.feature.ndjson", 4);
        }
        
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute(callerLineNumber: 7, DisplayName="Get actor chat session")]
        ...
        public async global::System.Threading.Tasks.Task GetActorChatSession(string def, string response, string responseErrors, string id, string chatSessionId, string chatSessionExists, string @__pickleIndex, string[] exampleTags)
        {
            ...
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Get actor chat session", null, tagsOfScenario, argumentsOfScenario, featureTags, pickleIndex);

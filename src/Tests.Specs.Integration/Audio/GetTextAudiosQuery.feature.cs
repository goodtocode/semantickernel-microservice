...
namespace Goodtocode.SemanticKernel.Specs.Integration.Audio
{
    ...
    public partial class GetTextAudiosQueryFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Audio", "Get Text Audios Query", "As a session owner\r\nWhen I query text audio optionally by date range\r\nI get all s" +
...
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Audio/GetTextAudiosQuery.feature.ndjson", 6);
        }
        
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute(callerLineNumber: 7, DisplayName="Get text audios")]
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get text audios")]
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Get Text Audios Query")]
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("getTextAudiosQuery")]
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.DataRowAttribute("success no date range", "Success", "", "", "", "true", "true", "0", null, DisplayName="GetTextAudios(success no date range,Success,,,,true,true,0)")]
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.DataRowAttribute("success with date range", "Success", "", "2024-06-01T11:21:00Z", "2034-06-03T11:21:00Z", "true", "true", "1", null, DisplayName="GetTextAudios(success with date range,Success,,2024-06-01T11:21:00Z,2034-06-03T11" +
            ":21:00Z,true,true,1)")]
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.DataRowAttribute("success filtered results", "Success", "", "2024-06-01T11:21:00Z", "2034-06-03T11:21:00Z", "true", "false", "2", null, DisplayName="GetTextAudios(success filtered results,Success,,2024-06-01T11:21:00Z,2034-06-03T1" +
            "1:21:00Z,true,false,2)")]
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.DataRowAttribute("success empty results", "Success", "", "", "", "false", "false", "3", null, DisplayName="GetTextAudios(success empty results,Success,,,,false,false,3)")]
        public async global::System.Threading.Tasks.Task GetTextAudios(string def, string response, string responseErrors, string startDate, string endDate, string exist, string textPromptsResultExists, string @__pickleIndex, string[] exampleTags)
        {
            ...
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Get text audios", null, tagsOfScenario, argumentsOfScenario, featureTags, pickleIndex);
...
#line hidden
#line 13
 await testRunner.WhenAsync("I get the text audio", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 14

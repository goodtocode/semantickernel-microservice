...
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Audio/GetTextAudiosPaginatedQuery.feature", 7);
        }
        
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute("Get text audio paginated")]
        ...
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.DataRowAttribute("success no date range", "Success", "", "", "", "true", "true", "1", "10", "0", null, DisplayName="Get text audio paginated(success no date range,Success,,,,true,true,1,10,0)")]
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.DataRowAttribute("success with date range", "Success", "", "2024-06-01T11:21:00Z", "2034-06-03T11:21:00Z", "true", "true", "1", "10", "1", null, DisplayName="Get text audio paginated(success with date range,Success,,2024-06-01T11:21:00Z,20" +
            "34-06-03T11:21:00Z,true,true,1,10,1)")]
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.DataRowAttribute("success empty results", "Success", "", "", "", "false", "false", "1", "10", "2", null, DisplayName="Get text audio paginated(success empty results,Success,,,,false,false,1,10,2)")]
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.DataRowAttribute("bad request page number zero", "BadRequest", "PageNumber", "", "", "false", "false", "0", "10", "3", null, DisplayName="Get text audio paginated(bad request page number zero,BadRequest,PageNumber,,,fal" +
            "se,false,0,10,3)")]
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.DataRowAttribute("bad request page size zero", "BadRequest", "PageSize", "", "", "false", "false", "1", "0", "4", null, DisplayName="Get text audio paginated(bad request page size zero,BadRequest,PageSize,,,false,f" +
            "alse,1,0,4)")]

...
namespace Goodtocode.SemanticKernel.Specs.Integration.Audio
{
    ...
    public partial class GetTextAudioPaginatedQueryFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Audio", "Get Text Audio Paginated Query", "As an owner of text audio\r\nWhen I get text audio all or by date range\r\nI can get " +
                "a paginated collection of text audio", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
...
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Audio/GetTextAudiosPaginatedQuery.feature.ndjson", 7);
        }
        
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute(callerLineNumber: 7, DisplayName="Get text audio paginated")]
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get text audio paginated")]
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Get Text Audio Paginated Query")]
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("getTextAudioPaginatedQuery")]
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.DataRowAttribute("success no date range", "Success", "", "", "", "true", "true", "1", "10", "0", null, DisplayName="GetTextAudioPaginated(success no date range,Success,,,,true,true,1,10,0)")]
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.DataRowAttribute("success with date range", "Success", "", "2024-06-01T11:21:00Z", "2034-06-03T11:21:00Z", "true", "true", "1", "10", "1", null, DisplayName="GetTextAudioPaginated(success with date range,Success,,2024-06-01T11:21:00Z,2034-" +
            "06-03T11:21:00Z,true,true,1,10,1)")]
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.DataRowAttribute("success empty results", "Success", "", "", "", "false", "false", "1", "10", "2", null, DisplayName="GetTextAudioPaginated(success empty results,Success,,,,false,false,1,10,2)")]
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.DataRowAttribute("bad request page number zero", "BadRequest", "PageNumber", "", "", "false", "false", "0", "10", "3", null, DisplayName="GetTextAudioPaginated(bad request page number zero,BadRequest,PageNumber,,,false," +
            "false,0,10,3)")]
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.DataRowAttribute("bad request page size zero", "BadRequest", "PageSize", "", "", "false", "false", "1", "0", "4", null, DisplayName="GetTextAudioPaginated(bad request page size zero,BadRequest,PageSize,,,false,fals" +
            "e,1,0,4)")]
        public async global::System.Threading.Tasks.Task GetTextAudioPaginated(string def, string response, string responseErrors, string startDate, string endDate, string exist, string textPromptsResultExists, string pageNumber, string pageSize, string @__pickleIndex, string[] exampleTags)
        {
            ...
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Get text audio paginated", null, tagsOfScenario, argumentsOfScenario, featureTags, pickleIndex);

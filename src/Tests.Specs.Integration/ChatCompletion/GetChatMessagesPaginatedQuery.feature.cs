...
#line 1 "GetChatMessagesPaginatedQuery.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "ChatCompletion", "Get Chat Messages Paginated Query", "As an owner of Chat Messages\r\nWhen I get Chat Messages all or by date range\r\nI ca" +
                    "n get a paginated collection of Chat Messages", ProgrammingLanguage.CSharp, featureTags);
        ...
        public void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "Get Chat Messages Paginated Query")))
            {
                global::Goodtocode.SemanticKernel.Specs.Integration.ChatCompletion.GetChatMessagesPaginatedQueryFeature.FeatureSetup(null);
            }
        }
        ...
        public virtual void GetChatMessagesPaginated(string def, string response, string responseErrors, string startDate, string endDate, string exist, string chatMessagesResultExists, string pageNumber, string pageSize, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("ChatMessagesResultExists", chatMessagesResultExists);
            argumentsOfScenario.Add("pageNumber", pageNumber);
            argumentsOfScenario.Add("pageSize", pageSize);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Get Chat Messages paginated", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 7
...
#line hidden
#line 9
 testRunner.And(string.Format("Chat Messages exist \"{0}\"", exist), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 10
...
#line hidden
#line 12
 testRunner.And(string.Format("Chat Messages within the date range exists \"{0}\"", chatMessagesResultExists), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 13
...
#line hidden
#line 15
 testRunner.When("I get the Chat Messages paginated", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 16
...
#line hidden
#line 18
 testRunner.And("The response has a collection of Chat Messages", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 19
 testRunner.And("Each Chat Message has a Key", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 20
 testRunner.And("Each Chat Message has a Date greater than start date", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 21
 testRunner.And("Each Chat Message has a Date less than end date", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 22
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get Chat Messages paginated: success no date range")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Get Chat Messages Paginated Query")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("getChatMessagesPaginatedQuery")]
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:ChatMessagesResultExists", "true")]
        ...
        public void GetChatMessagesPaginated_SuccessNoDateRange()
        {
#line 7
this.GetChatMessagesPaginated("success no date range", "Success", "", "", "", "true", "true", "1", "10", ((string[])(null)));
#line hidden
        }
        
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get Chat Messages paginated: success with date range")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Get Chat Messages Paginated Query")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("getChatMessagesPaginatedQuery")]
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:pageNumber", "1")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:pageSize", "10")]
        public void GetChatMessagesPaginated_SuccessWithDateRange()
        {
#line 7
this.GetChatMessagesPaginated("success with date range", "Success", "", "2024-06-01T11:21:00Z", "2024-06-03T11:21:00Z", "true", "true", "1", "10", ((string[])(null)));
#line hidden
        }
        
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get Chat Messages paginated: success empty results")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Get Chat Messages Paginated Query")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("getChatMessagesPaginatedQuery")]
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:ChatMessagesResultExists", "false")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:pageNumber", "1")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:pageSize", "10")]
        public void GetChatMessagesPaginated_SuccessEmptyResults()
        {
#line 7
this.GetChatMessagesPaginated("success empty results", "Success", "", "", "", "false", "false", "1", "10", ((string[])(null)));
#line hidden
        }
        
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get Chat Messages paginated: bad request page number zero")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Get Chat Messages Paginated Query")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("getChatMessagesPaginatedQuery")]
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:pageSize", "10")]
        public void GetChatMessagesPaginated_BadRequestPageNumberZero()
        {
#line 7
this.GetChatMessagesPaginated("bad request page number zero", "BadRequest", "PageNumber", "", "", "false", "false", "0", "10", ((string[])(null)));
#line hidden
        }
        
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get Chat Messages paginated: bad request page size zero")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Get Chat Messages Paginated Query")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("getChatMessagesPaginatedQuery")]
        ...
        public void GetChatMessagesPaginated_BadRequestPageSizeZero()
        {
#line 7
this.GetChatMessagesPaginated("bad request page size zero", "BadRequest", "PageSize", "", "", "false", "false", "1", "0", ((string[])(null)));
#line hidden
        }
    }
}

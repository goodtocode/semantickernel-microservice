...
namespace Goodtocode.SemanticKernel.Specs.Integration.ChatCompletion
{
    ...
    public partial class GetChatMessagesPaginatedQueryFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "ChatCompletion", "Get Chat Messages Paginated Query", "As an owner of Chat Messages\r\nWhen I get Chat Messages all or by date range\r\nI ca" +
                "n get a paginated collection of Chat Messages", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get Chat Messages paginated")]
        ...
        public async global::System.Threading.Tasks.Task GetChatMessagesPaginated(string def, string response, string responseErrors, string startDate, string endDate, string exist, string chatMessagesResultExists, string pageNumber, string pageSize, string[] exampleTags)
        {
            ...
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Get Chat Messages paginated", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 7

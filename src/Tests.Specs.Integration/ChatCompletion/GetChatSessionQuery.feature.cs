...
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("ChatCompletion/GetChatSessionQuery.feature.ndjson", 5);
        }
        
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute(callerLineNumber: 7, DisplayName="Get chat session")]
        ...
        public async global::System.Threading.Tasks.Task GetChatSession(string def, string response, string responseErrors, string id, string chatSessionExists, string expectedChatSessionCount, string @__pickleIndex, string[] exampleTags)
        {
            ...
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Get chat session", null, tagsOfScenario, argumentsOfScenario, featureTags, pickleIndex);

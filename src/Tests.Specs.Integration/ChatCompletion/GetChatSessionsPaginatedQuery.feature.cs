...
namespace Goodtocode.SemanticKernel.Specs.Integration.ChatCompletion
{
    ...
    public partial class GetChatSessionsPaginatedQueryFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "ChatCompletion", "Get Chat Sessions Paginated Query", "As an owner of chat sessions\r\nWhen I get chat sessions all or by date range\r\nI ca" +
                "n get a paginated collection of chat sessions", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get chat sessions paginated")]
        ...
        public async global::System.Threading.Tasks.Task GetChatSessionsPaginated(string def, string response, string responseErrors, string startDate, string endDate, string exist, string chatSessionsResultExists, string pageNumber, string pageSize, string[] exampleTags)
        {
            ...
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Get chat sessions paginated", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 7

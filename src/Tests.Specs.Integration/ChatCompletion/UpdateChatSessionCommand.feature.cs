...
namespace Goodtocode.SemanticKernel.Specs.Integration.ChatCompletion
{
    ...
    public partial class UpdateChatSessionCommandFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "ChatCompletion", "Update Chat Session Command", "As a chat session owner\r\nWhen I edit a chat session\r\nI am able to change or add t" +
                "o the chat session", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
...
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("ChatCompletion/UpdateChatSessionCommand.feature.ndjson", 5);
        }
        
        [global::Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute(callerLineNumber: 7, DisplayName="Update Chat Session")]
        ...
        public async global::System.Threading.Tasks.Task UpdateChatSession(string def, string response, string responseErrors, string id, string exists, string @__pickleIndex, string[] exampleTags)
        {
            ...
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Update Chat Session", null, tagsOfScenario, argumentsOfScenario, featureTags, pickleIndex);

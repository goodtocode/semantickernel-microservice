...
namespace Goodtocode.SemanticKernel.Specs.Integration.Image
{
    ...
    public partial class GetTextImagePaginatedQueryFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Image", "Get Text Image Paginated Query", "As an owner of text image\r\nWhen I get text image all or by date range\r\nI can get " +
                "a paginated collection of text image", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get text image paginated")]
        ...
        public async global::System.Threading.Tasks.Task GetTextImagePaginated(string def, string response, string responseErrors, string startDate, string endDate, string exist, string textPromptsResultExists, string pageNumber, string pageSize, string[] exampleTags)
        {
            ...
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Get text image paginated", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 7

...
#line 1 "GetTextPromptsPaginatedQuery.feature"
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "TextGeneration", "Get Text Prompt Paginated Query", "As an owner of text prompt\r\nWhen I get text prompt all or by date range\r\nI can ge" +
                    "t a paginated collection of text prompt", ProgrammingLanguage.CSharp, featureTags);
        ...
        public void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "Get Text Prompt Paginated Query")))
            {
                global::Goodtocode.SemanticKernel.Specs.Integration.TextGeneration.GetTextPromptPaginatedQueryFeature.FeatureSetup(null);
            }
        }
        ...
        public virtual void GetTextPromptPaginated(string def, string response, string responseErrors, string startDate, string endDate, string exist, string textPromptsResultExists, string pageNumber, string pageSize, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Get text prompt paginated", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 7
...
#line hidden
#line 15
 testRunner.When("I get the text prompt paginated", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 16
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get text prompt paginated: success no date range")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Get Text Prompt Paginated Query")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("getTextPromptsPaginatedQuery")]
        ...
        public void GetTextPromptPaginated_SuccessNoDateRange()
        {
#line 7
this.GetTextPromptPaginated("success no date range", "Success", "", "", "", "true", "true", "1", "10", ((string[])(null)));
#line hidden
        }
        
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get text prompt paginated: success with date range")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Get Text Prompt Paginated Query")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("getTextPromptsPaginatedQuery")]
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:pageNumber", "1")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:pageSize", "10")]
        public void GetTextPromptPaginated_SuccessWithDateRange()
        {
#line 7
this.GetTextPromptPaginated("success with date range", "Success", "", "2024-06-01T11:21:00Z", "2034-06-03T11:21:00Z", "true", "true", "1", "10", ((string[])(null)));
#line hidden
        }
        
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get text prompt paginated: success empty results")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Get Text Prompt Paginated Query")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("getTextPromptsPaginatedQuery")]
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:pageNumber", "1")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:pageSize", "10")]
        public void GetTextPromptPaginated_SuccessEmptyResults()
        {
#line 7
this.GetTextPromptPaginated("success empty results", "Success", "", "", "", "false", "false", "1", "10", ((string[])(null)));
#line hidden
        }
        
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get text prompt paginated: bad request page number zero")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Get Text Prompt Paginated Query")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("getTextPromptsPaginatedQuery")]
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:pageSize", "10")]
        public void GetTextPromptPaginated_BadRequestPageNumberZero()
        {
#line 7
this.GetTextPromptPaginated("bad request page number zero", "BadRequest", "PageNumber", "", "", "false", "false", "0", "10", ((string[])(null)));
#line hidden
        }
        
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get text prompt paginated: bad request page size zero")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Get Text Prompt Paginated Query")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("getTextPromptsPaginatedQuery")]
        ...
        public void GetTextPromptPaginated_BadRequestPageSizeZero()
        {
#line 7
this.GetTextPromptPaginated("bad request page size zero", "BadRequest", "PageSize", "", "", "false", "false", "1", "0", ((string[])(null)));
#line hidden
        }
    }
}

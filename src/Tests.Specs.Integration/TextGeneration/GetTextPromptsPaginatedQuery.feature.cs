...
namespace Goodtocode.SemanticKernel.Specs.Integration.TextGeneration
{
    ...
    public partial class GetTextPromptPaginatedQueryFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "TextGeneration", "Get Text Prompt Paginated Query", "As an owner of text prompt\r\nWhen I get text prompt all or by date range\r\nI can ge" +
                "t a paginated collection of text prompt", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get text prompt paginated")]
        ...
        public async global::System.Threading.Tasks.Task GetTextPromptPaginated(string def, string response, string responseErrors, string startDate, string endDate, string exist, string textPromptsResultExists, string pageNumber, string pageSize, string[] exampleTags)
        {
            ...
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Get text prompt paginated", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 7

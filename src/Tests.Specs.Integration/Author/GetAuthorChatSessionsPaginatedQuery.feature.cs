...
namespace Goodtocode.SemanticKernel.Specs.Integration.Author
{
    ...
    public partial class GetAuthorChatSessionsPaginatedQueryFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Author", "Get Author Chat Sessions Paginated Query", "As an author of chat sessions\r\nWhen I get chat sessions by author or by date rang" +
                "e\r\nI can get a paginated collection of chat sessions", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Get author chat sessions paginated")]
        ...
        public async global::System.Threading.Tasks.Task GetAuthorChatSessionsPaginated(string def, string response, string responseErrors, string id, string startDate, string endDate, string exist, string chatSessionsResultExists, string pageNumber, string pageSize, string[] exampleTags)
        {
            ...
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Get author chat sessions paginated", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 7

...
public class GetAuthorChatSessionsPaginatedQueryHandler(ISemanticKernelContext context) : IRequestHandler<GetActorChatSessionsPaginatedQuery, PaginatedList<ChatSessionDto>>
{

...
public class GetTextAudioPaginatedQueryHandler(ISemanticKernelContext context, IMapper mapper) : IRequestHandler<GetTextAudioPaginatedQuery, PaginatedList<TextAudioDto>>
{
